...
layout = html.Div([
    html.Div([
        dcc.Link('Navigate to "/"', href='/Database/test'),
        html.Br(),
...
def inche(str):
    ...
    b2 = tk.Button(fram3, text='Courbes pour :' + format(', '.join(str)), borderwidth=0,
                   command=lambda: hide_widget(str))
    b2['font'] = myFont2
